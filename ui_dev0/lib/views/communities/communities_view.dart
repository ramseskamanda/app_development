...
import 'package:ui_dev0/views/communities/communities_view_mobile.dart';
...
class CommunitiesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseWidget<CommunitiesController>(
      viewModel: CommunitiesController(),
      onModelReady: (model) async => await model.fetchData(),
      builder: (context) {
        return ScreenTypeLayout(
          mobile: OrientationLayout(
            portrait: (context) => CommunitiesViewMobilePortrait(),
          ),
